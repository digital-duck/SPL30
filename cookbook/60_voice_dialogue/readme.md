...
```bash
# macOS
say -o cookbook/60_voice_dialogue/sample/question.aiff "What is SPL 3.0 and why does it matter?"
...
```bash
# Minimal
python cookbook/60_voice_dialogue/run.py --audio question.wav
