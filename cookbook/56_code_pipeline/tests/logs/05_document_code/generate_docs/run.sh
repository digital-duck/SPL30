...
spl3 run /home/gong-mini/projects/digital-duck/SPL30/cookbook/56_code_pipeline/05_document_code.spl \
    --adapter ollama \
    --param "code=$CODE" \
    ...
    --param "log_dir=/home/gong-mini/projects/digital-duck/SPL30/cookbook/56_code_pipeline/tests/logs/05_document_code/generate_docs" 
