...
| `@output_dir` | TEXT | `cookbook/59_text_to_video/outputs` | Directory to write generated video |
| `@log_dir` | TEXT | `cookbook/59_text_to_video/logs-spl` | Directory for log output |
