...
|-----------|------|---------|-------------|
| `@audio_in` | AUDIO | `cookbook/55_voice_dialogue/sample/question.wav` | Source audio question file |
...
| `@output_dir` | TEXT | `cookbook/55_voice_dialogue/outputs` | Directory to write response audio |
| `@log_dir` | TEXT | `cookbook/55_voice_dialogue/logs-spl` | Directory for log output |
