...
# Read from file
python cookbook/53_text_to_speech/run.py \
    --file cookbook/56_code_pipeline/README.md \
...
| `@output_dir` | TEXT | `cookbook/53_text_to_speech/outputs` | Directory to write audio file |
| `@llm_model` | TEXT | `gemma4:e4b` | Local LLM for script prep |
| `@log_dir` | TEXT | `cookbook/53_text_to_speech/logs-spl` | Directory for log output |
