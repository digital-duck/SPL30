...
| `@output_dir` | TEXT | `cookbook/52_text_to_image/outputs` | Directory to write generated image |
| `@llm_model` | TEXT | `gemma4:e4b` | Local LLM for prompt enhancement |
| `@log_dir` | TEXT | `cookbook/52_text_to_image/logs-spl` | Directory for log output |
